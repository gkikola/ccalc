...
int main() {
  ...
  assert(expect("-242837.23413986", "-p 8 -g 0", "-242837.23413986"));
  assert(expect("-242837.23413986", "-p 8 -g 1",
		"-2 4 2 8 3 7.2 3 4 1 3 9 8 6"));
  assert(expect("-242837.23413986", "-p 8 -g 2", "-24 28 37.23 41 39 86"));
  assert(expect("-242837.23413986", "-p 8 -g 3", "-242 837.234 139 86"));
